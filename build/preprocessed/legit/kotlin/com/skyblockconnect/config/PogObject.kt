...
import com.skyblockconnect.SkyblockConnect.MOD_NAME
import com.skyblockconnect.utils.GsonUtils
...
class PogObject<T: Any>(val fileName: String, @Volatile private var data: T, private val type: Type) {
    ...
    private fun loadData(): T {
        ...
        return try {
            ...
            SkyblockConnect.logger.warn("PogObject: failed to load $fileName", e)
            e.printStackTrace()
            throw e
        }
    }
    ...
    fun save() = try {
        ...
        SkyblockConnect.logger.warn("PogObject: failed to save $fileName", e)
        e.printStackTrace()
        throw e
    }
