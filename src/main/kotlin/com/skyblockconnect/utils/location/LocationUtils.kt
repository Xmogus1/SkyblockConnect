package com.skyblockconnect.utils.location
...
import com.skyblockconnect.event.impl.MainThreadPacketReceivedEvent
...
import com.skyblockconnect.utils.startsWithOneOf
...
object LocationUtils {
    ...
    init {
        EventBus.register<MainThreadPacketReceivedEvent.Post>(EventPriority.HIGHEST) {
            if (SkyblockConnect.isDev) return@register setDevModeValues()
